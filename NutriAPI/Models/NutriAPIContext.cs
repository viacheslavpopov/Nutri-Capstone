    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Supplement>()
        .HasData(
          ...
          new Supplement { SupplementId = 9, Type = "Herb", Name = "Beet Root Powder", Dosing = "No established dose. Use as directed on the supplement bottle.", Contraindications = "Consult your physician before use if you are currently on any blood pressure medications.", Maladies = "Athletic Performance, Heart Health"}
        );
    }
  }
}