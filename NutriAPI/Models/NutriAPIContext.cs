    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Supplement>()
        .HasData(
          ...
          new Supplement { SupplementId = 7, Type = "Herb", Name = "Bitters", Dosing = "No established dose. Use as directed on the supplement bottle. Generally taken before each meal to stimulate digestion.", Contraindications = "Consult your physician before use if you have a diagnosed digestive issue such as IBS, IBD, Crohns Disease, etc.", Maladies = "Digestive Health"},
          new Supplement { SupplementId = 8, Type = "Miscellanous Nutrient", Name = "Hydroxymethylbutyrate (HMB)", Dosing = "No established dose. Use as directed on the supplement bottle. It's important to note that the body produces HMB naturally, but additional supplementation may benefit body-building efforts.", Contraindications = "None established.", Maladies = "Athletic Performance"},
          new Supplement { SupplementId = 9, Type = "Herb", Name = "Beet Root Powder", Dosing = "No established dose. Use as directed on the supplement bottle. It's important to note that the body produces HMB naturally, but additional supplementation may benefit body-building efforts.", Contraindications = "Consult your physician before use if you are currently on any blood pressure medications.", Maladies = "Athletic Performance, Heart Health"}
        );
    }
  }
}