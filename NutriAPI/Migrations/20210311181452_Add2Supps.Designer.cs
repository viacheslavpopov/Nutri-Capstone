...
namespace NutriAPI.Migrations
{
    ...
    [Migration("20210311181452_Add2Supps")]
    partial class Add2Supps
    {
            ...
            modelBuilder.Entity("NutriAPI.Models.Supplement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SupplementId = 10,
                            Contraindications = "Lutein accumulates in the eyes and brain but does not seem to cause any harm in those who consume up to 40mg per day. Research seems to show a strong correlation between higher amounts of lutein in the brain and eyes with improved brain function and vision health. Lutein is typically sourced from marigold flowers, so those with ragweed allergies may be sensitive to consumption.",
                            Dosing = "No established dose. Generally doses range from 5mg-40mg.",
                            Maladies = "Eye Health, Brain Health",
                            Name = "Lutein",
                            Type = "Herb"
                        },
                        new
                        {
                            SupplementId = 11,
                            Contraindications = "The Upper Limit (UL) established for Vitamin C is 2,000mg per day, but higher doses have been used in acute cases as prescribed by a physician.",
                            Dosing = "Optimal daily intake is 2,000mg per day, but the minimum should be 250mg per day. For information about different types of Vitamin C supplements, visit the Linus Pauling Micronutrient Information Center found on the Resources page.",
                            Maladies = "Skin Health, Detox Support, Athletic Performance, Immune System Support",
                            Name = "Vitamin C",
                            Type = "Vitamin"
                        });
                });
